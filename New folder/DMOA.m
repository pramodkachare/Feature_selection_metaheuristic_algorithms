...
%_______________________________________________________________________________________%
%_______________________________________________________________________________________%
function [BEF,BEP,BestCost]=DMOA(nPop,MaxIt,VarMin,VarMax,nVar,F_obj, data, target)
...
for i=1:nAlphaGroup
    ...
    pop(i).Cost=F_obj(pop(i).Position, data, target);
...
for it=1:MaxIt
    ...
    for m=1:nAlphaGroup
        ...
        % Evaluation
        newpop.Cost=F_obj(newpop.Position, data, target);
   ...
   if mod(it,1)==0  %Print the best universe details after every t iterations
